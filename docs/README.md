...
- Keep primary documents in English.
- Keep code comments and code-facing identifiers in English.
- Track vulnerabilities, requirements, and design decisions as separate artifacts.
- Update the tracker and affected documents together when new OpenClaw issues are disclosed.
